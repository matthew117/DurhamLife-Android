...
{
	private static GlobalApplicationData sInstance;
	...
	{
		Editor editor = context.getSharedPreferences(REPORTING_PREFERENCES_KEY,
	...
	public static boolean getAnalyticsPermission(Context context)
	{
		SharedPreferences sharedPreferences = context.getSharedPreferences(
				REPORTING_PREFERENCES_KEY, Context.MODE_PRIVATE);
